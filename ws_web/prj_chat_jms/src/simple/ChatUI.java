...
public class ChatUI extends JFrame {
	...
	private JScrollPane getJScrollPaneConversacion() {
		if (jScrollPaneConversacion == null) {
			...
			jScrollPaneConversacion.setBorder(new javax.swing.border.TitledBorder(null, "Conversaci�n", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(0, 102, 102)));
		}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabelNombreConversacion.setText("Nombre conversaci�n");
