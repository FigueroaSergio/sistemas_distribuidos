        ...
        try (com.zeroc.Ice.Communicator ic = com.zeroc.Ice.Util.initialize(initData)) {
            ...
            while (!cameraConnected) {
                try {
                    ...
                    System.out.println(
                            "Objeto distribuido ICE \"Camara\" no disponible, nuevo intento de conexion en 2 segundos.");
                    try {
                        Thread.sleep(2000);
            ...
            com.zeroc.Ice.Object robotIceObject = new RobotI(robotName, camProxy, ic);
            adapter.add(robotIceObject, com.zeroc.Ice.Util.stringToIdentity("RobotSeguidor"));
            // Activate adapter
            adapter.activate();
            //
            com.zeroc.Ice.ObjectPrx proxy = adapter
                    .createDirectProxy(com.zeroc.Ice.Util.stringToIdentity("RobotSeguidor"));
            String robotIOR = ic.proxyToString(proxy);
            ///////////////////////////////////////////////////////////////////////////////
            ...
            RobotI robotI = (RobotI) robotIceObject;
            robotI.setRobotIOR(robotIOR);
            if (args.length > 0)
                robotI.setNombre(args[0]);
            // Arrancar robot
            robotI.start();
            //
            // Block main thread.
