...
{
    default String serviceEcho(String input)
    {
        return serviceEcho(input, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String serviceEcho(String input, java.util.Map<String, String> context)
    {
        return _iceI_serviceEchoAsync(input, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> serviceEchoAsync(String input)
    {
        return _iceI_serviceEchoAsync(input, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> serviceEchoAsync(String input, java.util.Map<String, String> context)
    {
        return _iceI_serviceEchoAsync(input, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_serviceEchoAsync(String iceP_input, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "serviceEcho", null, sync, null);
